# Generated by Django 2.1 on 2018-12-22 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Новый'), (2, 'Готовится'), (3, 'В пути'), (4, 'Доставлен'), (5, 'Отменён')], default=1, verbose_name='Статус')),
                ('courier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='delivered', to=settings.AUTH_USER_MODEL, verbose_name='Курьер')),
                ('operator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='orders', to=settings.AUTH_USER_MODEL, verbose_name='Оператор')),
            ],
        ),
        migrations.CreateModel(
            name='OrderFood',
